...
/*
 * Hover state used to be React state driving a framer-motion tooltip — a
 * re-render plus an animation library on every page, for an effect CSS does for
 * free. `peer`/`group` handles it with zero JS.
 */
