...
const BottomNav = () => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 z-50 flex justify-around items-center h-16 pb-safe shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
      ...
      <Link to="/cart" data-cart-tab className={`flex flex-col items-center justify-center w-full h-full gap-1 p-2 min-w-[44px] min-h-[44px] relative transition-colors ${isActive('/cart') ? 'text-primary' : 'text-gray-400 hover:text-secondary'}`}>
